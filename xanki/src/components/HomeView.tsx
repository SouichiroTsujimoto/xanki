...
export function HomeView({
  ...
  return (
    <div className="home-view">
      {selectedDeck ? (
        <section className="home-spotlight" aria-label="現在のデッキ">
          <p className="eyebrow home-spotlight-eyebrow">現在のデッキ</p>
        ...
        <section className="home-spotlight">
          <p className="eyebrow home-spotlight-eyebrow">はじめに</p>
          <h2 className="home-spotlight-title">デッキを選びましょう</h2>
          <p className="home-capture-hint">
            下の一覧からデッキを選ぶか、新しいデッキを作成してください。
          </p>
        </section>
      )}

      <section className="home-decks-section" aria-label="デッキ一覧">
        <h3 className="home-decks-heading">デッキ一覧</h3>
        {decks.length === 0 ? (
          <div className="empty-panel home-empty">
            <p className="empty-title">デッキがありません</p>
            <p className="empty-copy">下のフォームから最初のデッキを作成してください。</p>
          </div>
        ) : (
      ...
      <section className="home-create-bar" aria-label="デッキの追加">
        ...
        <p className="home-capture-hint">
          カード追加: <kbd>⌥⌘M</kbd> テキスト · <kbd>⌥⌘S</kbd> スクショ
        </p>
      </section>
