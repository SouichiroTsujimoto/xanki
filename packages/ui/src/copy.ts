...
export const copy = {
  ...
  deckStudy: {
    ...
    /** Swipes completed / cards in current round (0 while viewing the first card). */
    sessionSwiped: (swiped: number, roundTotal: number) => `${swiped} / ${roundTotal}`,
    known: "覚えた",
    still: "まだ",
    /** Flashcard round: keep for next pass (Quizlet-style). */
    stillAgain: "もう一度",
    knownThisRound: "今回覚えた",
    stillRemaining: "残り",
    knownTotal: "累計覚えた",
    nextRound: "次の周へ",
    roundCompleteTitle: "この周の結果",
    roundCompleteCopy: (known: number, still: number) =>
      `${known} 枚覚えて、${still} 枚が次の周に残っています。`,
    sessionCompleteTitle: "このデッキの学習が完了しました",
    sessionCompleteCopy: "すべてのカードを覚えました。",
    sessionRestart: "もう一度",
    flashcardHintFront: "Space / クリック 答え · 答え後に左右スワイプ",
    flashcardHintBack: "← もう一度 · 覚えた → · 1 / 2",
  ...
  editor: {
    ...
    createImage: "暗記カード作成 ✦",
    editImage: "スクショ編集 ✦",
    qaToggle: "一問一答モードに切り替える",
    qaExit: "マスクモードに切り替える（問題文と解答を連結）",
    modeToggleLabel: "カード作成モード",
    qaMode: "一問一答",
    questionLabel: "問題文",
    answerLabel: "解答",
